  ...
  return (
    <Slide>
      ...
      <SideNotes>
        ...
        micro-frontends (click: micro-frontends), it is very complex, very hard to reason about when first getting
        started with it, but we use it because in the long run, the advantages overweigh the disadvantages. And if a
        programmer comes along and says "hey man, this is too complex, I can't understand this", we tell him "You're a
        programmer, learn how to fish".
      </SideNotes>
    </Slide>
  );
}
